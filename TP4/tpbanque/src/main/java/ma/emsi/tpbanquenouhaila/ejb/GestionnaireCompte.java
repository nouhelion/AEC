...
public class GestionnaireCompte {
    ...
    public void transferer(CompteBancaire source, CompteBancaire destination,
            int montant) throws CompteException {
     ...
     * @param compteBancaire
     * @param montant
     * @throws ma.emsi.tpbanquenouhaila.ejb.CompteException
     */
    public void retirer(CompteBancaire compteBancaire, int montant) throws CompteException {
